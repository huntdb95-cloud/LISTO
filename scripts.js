...
const I18N = {
  en: {
    ...
    "auth.footnote": "Secure sign-in powered by Firebase",
    "auth.footnoteSignup": "Secure sign-up powered by Firebase",
    "auth.footnoteReset": "Secure password reset powered by Firebase",
    "auth.animationWelcome": "Welcome back!",
    "auth.animationLoading": "Loading your dashboard...",

    "signup.phoneNumber": "Phone Number *",
    "signup.phonePlaceholder": "(555) 555-5555",
    "signup.addressStreet": "Street Address *",
    "signup.addressStreetPlaceholder": "123 Main Street",
    "signup.addressCity": "City *",
    "signup.addressCityPlaceholder": "City",
    "signup.addressState": "State *",
    "signup.selectState": "Select State",
    "signup.addressZip": "ZIP Code *",
    "signup.addressZipPlaceholder": "12345",
    ...
    "auth.error.tooManyRequests": "Too many attempts. Please wait a bit and try again.",
    "auth.error.loginFailed": "Login failed. Please try again.",
    "auth.error.emailInUse": "That email is already in use. Try logging in instead.",
    "auth.error.weakPassword": "Password is too weak. Use at least 6 characters.",
    "auth.error.notAllowed": "Email/password sign-up is not enabled in Firebase Auth.",
    "auth.error.signupFailed": "Sign up failed. Please try again.",
    "auth.error.userNotFound": "If an account exists for that email, a reset link will be sent.",
    "auth.error.resetFailed": "Could not send reset email. Please try again.",
    "auth.error.resetSent": "If an account exists for that email, a reset link has been sent.",
    "auth.language.en": "English",
    "auth.language.es": "Español",
    "signup.error.noDisplayName": "Please enter a company / display name.",
    "signup.error.displayNameTooLong": "Display name is too long (max 80 characters).",
    "signup.error.passwordsNotMatch": "Passwords do not match. Please try again.",
    "signup.error.mustAcceptTerms": "You must accept the Terms and Conditions to create an account.",
    "signup.error.noPhone": "Please enter your phone number.",
    "signup.error.invalidPhone": "Please enter a valid phone number (at least 10 digits).",
    "signup.error.noStreet": "Please enter your street address.",
    "signup.error.noCity": "Please enter your city.",
    "signup.error.noState": "Please select your state.",
    "signup.error.invalidState": "Please select a valid state.",
    "signup.error.noZip": "Please enter your ZIP code.",
    "signup.error.invalidZip": "Please enter a valid ZIP code (5 digits or 5+4 format).",

    "settings.languageUpdating": "Updating language preference...",
    "settings.languageUpdated": "Language preference updated successfully!",
    
    "account.contactTitle": "Contact & Address",
    "account.contactDesc": "Update your phone number and business address. This information will be used to autofill invoices and tax forms.",
    "account.saveContact": "Save Contact & Address",
    "account.taxTitle": "Tax Information",
    "account.taxDesc": "Taxpayer Identification Number (TIN / EIN / SSN). Optional. Used to autofill your 1099-NEC payer info.",
    "account.taxLabel": "Taxpayer Identification Number (TIN / EIN / SSN)",
    "account.taxPlaceholder": "12-3456789",
    "account.taxFormat": "Format: XX-XXXXXXX (EIN) or XXX-XX-XXXX (SSN)",
    "account.saveTax": "Save Tax Information"
  },
  ...
  es: {
    ...
    "auth.footnote": "Inicio de sesión seguro con Firebase",
    "auth.footnoteSignup": "Registro seguro con Firebase",
    "auth.footnoteReset": "Restablecimiento de contraseña seguro con Firebase",
    "auth.animationWelcome": "¡Bienvenido de nuevo!",
    "auth.animationLoading": "Cargando tu panel...",

    "signup.phoneNumber": "Número de Teléfono *",
    "signup.phonePlaceholder": "(555) 555-5555",
    "signup.addressStreet": "Dirección *",
    "signup.addressStreetPlaceholder": "123 Main Street",
    "signup.addressCity": "Ciudad *",
    "signup.addressCityPlaceholder": "Ciudad",
    "signup.addressState": "Estado *",
    "signup.selectState": "Seleccionar Estado",
    "signup.addressZip": "Código Postal *",
    "signup.addressZipPlaceholder": "12345",

    "auth.error.invalidEmail": "Por favor ingresa una dirección de correo válida.",
    "auth.error.invalidCredential": "Correo o contraseña incorrectos.",
    "auth.error.userDisabled": "Esta cuenta ha sido deshabilitada.",
    "auth.error.tooManyRequests": "Demasiados intentos. Por favor espera un momento e intenta de nuevo.",
    "auth.error.loginFailed": "Inicio de sesión fallido. Por favor intenta de nuevo.",
    "auth.error.emailInUse": "Ese correo ya está en uso. Intenta iniciar sesión en su lugar.",
    "auth.error.weakPassword": "La contraseña es muy débil. Usa al menos 6 caracteres.",
    "auth.error.notAllowed": "El registro con correo/contraseña no está habilitado en Firebase Auth.",
    "auth.error.signupFailed": "Registro fallido. Por favor intenta de nuevo.",
    "auth.error.userNotFound": "Si existe una cuenta para ese correo, se enviará un enlace de restablecimiento.",
    "auth.error.resetFailed": "No se pudo enviar el correo de restablecimiento. Por favor intenta de nuevo.",
    "auth.error.resetSent": "Si existe una cuenta para ese correo, se ha enviado un enlace de restablecimiento.",
    "auth.language.en": "English",
    "auth.language.es": "Español",
    "signup.error.noDisplayName": "Por favor ingresa un nombre de empresa / para mostrar.",
    "signup.error.displayNameTooLong": "El nombre para mostrar es muy largo (máx. 80 caracteres).",
    "signup.error.passwordsNotMatch": "Las contraseñas no coinciden. Por favor intenta de nuevo.",
    "signup.error.mustAcceptTerms": "Debes aceptar los Términos y Condiciones para crear una cuenta.",
    "signup.error.noPhone": "Por favor ingresa tu número de teléfono.",
    "signup.error.invalidPhone": "Por favor ingresa un número de teléfono válido (al menos 10 dígitos).",
    "signup.error.noStreet": "Por favor ingresa tu dirección.",
    "signup.error.noCity": "Por favor ingresa tu ciudad.",
    "signup.error.noState": "Por favor selecciona tu estado.",
    "signup.error.invalidState": "Por favor selecciona un estado válido.",
    "signup.error.noZip": "Por favor ingresa tu código postal.",
    "signup.error.invalidZip": "Por favor ingresa un código postal válido (5 dígitos o formato 5+4).",

    "settings.languageUpdating": "Actualizando preferencia de idioma...",
    "settings.languageUpdated": "¡Preferencia de idioma actualizada exitosamente!",
    
    "account.contactTitle": "Contacto y Dirección",
    "account.contactDesc": "Actualiza tu número de teléfono y dirección comercial. Esta información se usará para autocompletar facturas y formularios fiscales.",
    "account.saveContact": "Guardar Contacto y Dirección",
    "account.taxTitle": "Información Fiscal",
    "account.taxDesc": "Número de Identificación Fiscal (TIN / EIN / SSN). Opcional. Se usa para autocompletar la información del pagador en tu 1099-NEC.",
    "account.taxLabel": "Número de Identificación Fiscal (TIN / EIN / SSN)",
    "account.taxPlaceholder": "12-3456789",
    "account.taxFormat": "Formato: XX-XXXXXXX (EIN) o XXX-XX-XXXX (SSN)",
    "account.saveTax": "Guardar Información Fiscal"
  }
};
